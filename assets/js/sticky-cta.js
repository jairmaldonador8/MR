      ...
      <div id="cta-menu-overlay" class="cta-menu-overlay">
        <div class="cta-menu">
          ...
          <button class="cta-menu-option cta-form-trigger">
            <span class="cta-menu-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><rect x="5" y="3" width="14" height="18" rx="2"/><line x1="9" y1="8" x2="15" y2="8"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="13" y2="16"/></svg></span>
            <span class="cta-menu-text">
